-- Apoio v2.11.4 — atualização não destrutiva.
-- Este arquivo não remove tabelas legadas regulacao_*; migre o eMulti primeiro e remova-as apenas depois, se desejar.
